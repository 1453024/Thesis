...
module.exports = {
  ...
  fetch: params => {
    ...
    return Question.findOne(
      _.pick(params, _.keys(Question.schema.paths))
    ).populate(populate)
  },
  ...
  remove: async params => {
    ...
    const data = await Question.findOneAndRemove(params, {}).populate(populate)
  ...
  count: params => {
    ...
    return Question.count().where(filters.where)
  }
}
