...
module.exports = {
  ...
  fetch: params => {
    ...
    return Subject.findOne(
      _.pick(params, _.keys(Subject.schema.paths))
    ).populate(populate)
  },
  ...
  add: async values => {
    ...
    return Subject.updateRelations({ id: entry.id, values: relations })
  },
  ...
  edit: async (params, values) => {
    ...
    const entry = await Subject.update(params, data, { multi: true })
  ...
  remove: async params => {
    ...
    const data = await Subject.findOneAndRemove(params, {}).populate(populate)
  ...
  count: params => {
    ...
    return Subject.count().where(filters.where)
  }
}
