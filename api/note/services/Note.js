...
module.exports = {
  ...
  fetch: params => {
    ...
    return Note.findOne(_.pick(params, _.keys(Note.schema.paths))).populate(
      populate
    )
  },
  ...
  remove: async params => {
    ...
    const data = await Note.findOneAndRemove(params, {}).populate(populate)
  ...
  count: params => {
    ...
    return Note.count().where(filters.where)
  }
}
